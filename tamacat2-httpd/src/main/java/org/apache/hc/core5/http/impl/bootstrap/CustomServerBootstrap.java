...
//	private org.apache.hc.core5.http.protocol.LookupRegistry<HttpRequestHandler> lookupRegistry;
    ...
    public static CustomServerBootstrap bootstrap() {
        return new CustomServerBootstrap();
    }
     ...
     */
    public final CustomServerBootstrap setListenerPort(final int listenerPort) {
     ...
     */
    public final CustomServerBootstrap setLocalAddress(final InetAddress localAddress) {
     ...
     */
    public final CustomServerBootstrap setSocketConfig(final SocketConfig socketConfig) {
     ...
     */
    public final CustomServerBootstrap setCharCodingConfig(final CharCodingConfig charCodingConfig) {
     ...
     */
    public final CustomServerBootstrap setHttpProcessor(final HttpProcessor httpProcessor) {
     ...
     */
    public final CustomServerBootstrap setConnectionReuseStrategy(final ConnectionReuseStrategy connStrategy) {
     ...
     */
    public final CustomServerBootstrap setResponseFactory(final HttpResponseFactory<ClassicHttpResponse> responseFactory) {
...
//    }
     ...
     */
    public final CustomServerBootstrap setConnectionFactory(
     ...
     */
    public final CustomServerBootstrap setServerSocketFactory(final ServerSocketFactory serverSocketFactory) {
     ...
     */
    public final CustomServerBootstrap setSslContext(final SSLContext sslContext) {
     ...
     */
    public final CustomServerBootstrap setSslSetupHandler(final Callback<SSLParameters> sslSetupHandler) {
     ...
     */
    public final CustomServerBootstrap setExceptionListener(final ExceptionListener exceptionListener) {
     ...
     * Assigns {@link ExceptionListener} instance.
     */
    public final CustomServerBootstrap setStreamListener(final Http1StreamListener streamListener) {
     ...
     */
    public final CustomServerBootstrap addFilterBefore(final String existing, final String name, final HttpFilterHandler filterHandler) {
     ...
     */
    public final CustomServerBootstrap addFilterAfter(final String existing, final String name, final HttpFilterHandler filterHandler) {
        Args.notBlank(existing, "Existing");
        Args.notBlank(name, "Name");
        Args.notNull(filterHandler, "Filter handler");
     ...
     */
    public final CustomServerBootstrap replaceFilter(final String existing, final HttpFilterHandler filterHandler) {
        Args.notBlank(existing, "Existing");
        Args.notNull(filterHandler, "Filter handler");
     ...
     */
    public final CustomServerBootstrap addFilterFirst(final String name, final HttpFilterHandler filterHandler) {
     ...
     */
    public final CustomServerBootstrap addFilterLast(final String name, final HttpFilterHandler filterHandler) {
        Args.notNull(name, "Name");
        Args.notNull(filterHandler, "Filter handler");
