...
/**
 * @see spring-core SystemPropertyUtils.java (Commits on May 29, 2020)
 * https://github.com/spring-projects/spring-framework/blob/main/spring-core/src/main/java/org/springframework/util/SystemPropertyUtils.java
 * 
...
public abstract class SystemPropertyUtils {
	...
	/**
	 * Resolve {@code ${...}} placeholders in the Property values
	 * ignoreUnresolvablePlaceholders=true
	 * @param props
	 * @return
	 */
	public static Properties resolvePlaceholders(Properties props) {
		Properties result = new Properties();
		props.forEach((key, value) -> {
			result.put(key, resolvePlaceholders((String)value, true));
		});
		return result;
	}
