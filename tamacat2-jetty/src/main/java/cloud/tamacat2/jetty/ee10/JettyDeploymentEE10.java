 ...
 */
package cloud.tamacat2.jetty.ee10;
...
import cloud.tamacat2.jetty.JettyDeployment;
import cloud.tamacat2.jetty.JettyManager;
import cloud.tamacat2.jetty.config.JettyUrlConfig;

/**
 * Deployment configuration for Jetty Embedded.
 */
public class JettyDeploymentEE10 implements JettyDeployment {

	static final Logger LOG = LoggerFactory.getLogger(JettyDeploymentEE10.class);
